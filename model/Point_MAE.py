...
def fps_batch(xyz, num_group):
    ...
    idx = fps(xyz_flat, batch, ratio=ratio)

    center = xyz_flat[idx]
    center = center.view(B, num_group, 3)
...
class Group(nn.Module):  # FPS + KNN
    ...
    def forward(self, xyz):
        ...
        # fps the centers out
        center = fps_batch(xyz, self.num_group)  #misc.fps(xyz, self.num_group) # B G 3
        # knn to get the neighborhood
        idx = knn_point(self.group_size, xyz, center) #self.knn(xyz, center) # B G M
